...
class TasksViewController: UITableViewController, UISearchResultsUpdating, UISearchBarDelegate, UINavigationControllerDelegate
{
    ...
    func createTask(task: String) {
        let doc = Task.create(taskListId: taskList.id, task: task)
        do {
    ...
    func deleteTask(taskID: String) {
        do {
            try DatabaseUtil.deleteDocumentWith(id: taskID)
        } catch let error as NSError {
