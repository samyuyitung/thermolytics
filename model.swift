...
func get_sat_vap_pressure(temp: Double) -> Double {     // saturated vapor pressure (mmHg)
    let p = 0.61121*pow(M_E,(18.678 - temp_air/234.5)*(temp_air/(257.14 + temp_air)))
    let p_mmhg = p*760/101.325                              // conversion from kPa to mmHg
    return p_mmhg
}

func get_temp_core(mass_body: Double, temp_skin_avg: Double, heart_rate_rest: Double, heart_rate: Double, rel_humidity: Double, temp_air: Double) -> Double {
...
var player_temp_core = get_temp_core(mass_body: mass_body,temp_skin_avg: temp_skin_avg,heart_rate_rest: heart_rate_rest,heart_rate: heart_rate,rel_humidity: rel_humidity,temp_air: temp_air)

print(player_temp_core)
